...
export default function App() {
  ...
  // Handle Footer Pages
  if (['features', 'use_cases', 'pricing', 'faq', 'terms', 'privacy', 'community', 'materials', 'news'].includes(currentApp || '')) {
      return <FooterPage pageId={currentApp!} onBack={() => setCurrentApp(null)} />;
  }
  ...
  // Removed 'album'
  if (['board', 'writing', 'reading', 'math', 'learning', 'gallery', 'refine', 'roster', 'handbook'].includes(currentApp || '')) {
    return (
        <BoardApp 
